...
import SVGBackground from "../element/SVGBackground";
import img1 from "../../images/landPage1.png";
import img2 from "../../images/landPage2.png";


export default function LandPage() {
    useEffect(() => {
        document.title = "SEA | Recibe tutorías con un click"
    }, []);
    return (
        <div id="landPage" className="c-svg_background--land smooth">
                ...
                <div id="mainLandPage">
                    <div className="c-content--main animate-content">
                        ...
                        <div className="c-btn--join">
                            <a className="btn btn-join smooth" href="https://discord.gg/FbVrHS79">

        ...
        <RNavbar collapseOnSelect sticky="top" expand="xl" id="navbar">
            ...
            <RNavbar.Collapse id="responsive-navbar-nav">
                <div className="nav-links navbar-nav">
                    <Nav.Link className="typo-nav-link nav-item-spaced mr-5 underlined-link animate-nav-item" href="/areas">AREA+ENLACES</Nav.Link>
                    <Nav.Link className="typo-nav-link nav-item-spaced mr-5 underlined-link animate-nav-item" href="/horarios">FRANJAS DE ATENCION</Nav.Link>
